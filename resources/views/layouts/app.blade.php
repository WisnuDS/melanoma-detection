...
<html lang="en">
	...
	<head><base href="../../">
		<meta charset="utf-8" />
		<title>Dashboard | Melanoma Detection</title>
		...
		<link href="{{asset("/css/themes/layout/brand/light.css?v=7.0.5")}}" rel="stylesheet" type="text/css" />
		<link href="{{asset("/css/themes/layout/aside/light.css?v=7.0.5")}}" rel="stylesheet" type="text/css" />
		<!--end::Layout Themes-->
