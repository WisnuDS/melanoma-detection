  ...
  <div class="container">
    ...
    <div class="d-flex flex-row">
      ...
      <div class="flex-row-fluid ml-lg-12">
        <!--begin::Form-->
        <form class="form" method="POST" action="{{ route(auth()->user()->roles[0]->name . '.users.update', ["id"=>$user->id]) }}">
          @method('PUT')
          @csrf
          <!--begin::Card-->
          <div class="card card-custom card-stretch">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-lg-9 col-xl-6">
                  <input class="form-control form-control-lg form-control-solid" type="text" value="{{ $user->email }}" name="email" />
                </div>
              </div>
              <div class="form-group row">
                <label class="col-xl-3 col-lg-3 col-form-label text-right">Tanggal Lahir</label>
                <div class="col-lg-9 col-xl-6">
                  <input class="form-control form-control-lg form-control-solid" type="date" value="{{ $user->birth_date }}" name="birth_date" />
