...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Authentication | Melanoma Detection</title>
		...
		<link href="{{asset("/css/pages/login/login-2.css?v=7.0.5")}}" rel="stylesheet" type="text/css" />
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						...
						<div class="d-flex flex-column-fluid flex-column flex-center">
							...
							<div class="login-form login-signin py-11">
								<!--begin::Form-->
								<form class="form" action="{{ route('login.store') }}" method="POST" id="kt_login_signin_form">
                                    @csrf
									<!--begin::Title-->
									...
									<div class="text-center pt-2">
										<input type="submit" value="Sign In" id="" class="btn btn-dark font-weight-bolder font-size-h6 px-8 py-4 my-3">
									</div>
									<!--end::Action-->
								</form>
								<!--end::Form-->
