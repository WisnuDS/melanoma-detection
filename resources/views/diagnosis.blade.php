         ...
         <div class="row">
          <div class="col-lg-6">
            <div class="form-group">
              ...
              <input class="form-control mb-10" placeholder="Nama" type="text" id="name">
              <label for="exampleSelect1">Jenis Kelamin</label>
              <select class="form-control mb-10" id="gender">
                <option disabled selected>Pilih Jenis Kelamin</option>
                <option value="P">Perempuan</option>
                <option value="L">Laki-laki</option>
              </select>
              <label for="exampleSelect1">Umur</label>
              <input class="form-control mb-10" placeholder="Umur" type="number" id="age">
